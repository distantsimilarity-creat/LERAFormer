...
class LERAFormerNoLCAF(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(4):
            ...
            trans2edge, trans2body = self.cfca[i](body_feat, edge_reprogrammed)

            fused_feat = body_feat + trans2body + edge_reprogrammed + trans2edge
...
if __name__ == '__main__':
    model = LERAFormerNoLCAF(in_chans=14, num_classes=2, use_dger=True)
